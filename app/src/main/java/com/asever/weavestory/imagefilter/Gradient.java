...
package com.asever.weavestory.imagefilter;
...
public class Gradient {
    ...
    private FilterPalette CreateGradient(List<Integer> colors, int length) {
        if (colors == null || colors.size() < 2) {
            return null;
        }

        FilterPalette palette = new FilterPalette(length);
        int[] red = palette.Red;
    ...
    public FilterPalette CreatePalette(int length) {
